...
{"name":"TitleNewGameOnly","status":false,"description":"ニューゲームオンリープラグイン","parameters":{"PressStart":"Press Start","FontFace":""}},
{"name":"RegionTerrain","status":true,"description":"リージョンにタイル属性を付与するプラグイン","parameters":{"梯子リージョンID":"1","茂みリージョンID":"2","カウンターリージョンID":"3","ダメージ床リージョンID":"4"}},
...
{"name":"CustomizeConfigItem","status":true,"description":"オプション任意項目作成プラグイン","parameters":{"スイッチ項目1":"スイッチ項目1:OFF:30:ON","数値項目1":"数値項目1:1:36:ON:1:10:1","音量項目1":"音量項目1:1:37:ON","文字項目1":"文字項目1:0:35:ON:EASY, NORMAL, HARD, VERY HARD","スイッチ項目2":"スイッチ項目2:OFF:31:OFF","数値項目2":"数値項目2:0:39:OFF:0:10:1","音量項目2":"音量項目2:0:40:OFF","文字項目2":"文字項目2:0:38:OFF:遅い, 普通, 速い, 最速"}},
