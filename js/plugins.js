...
var $plugins =
[
{"name":"DevToolsManage","status":true,"description":"デベロッパツール管理プラグイン","parameters":{"開始時に起動":"ON","常に前面表示":"OFF","デベロッパツール表示位置":"0,0,1200,800","最小化切替キー":"F8","リロードキー":"F12","画面の左寄せキー":"F11","高速化切替キー":"F10","強制戦闘勝利キー":"F7","FPS表示":"OFF","タイトルカット":"ON","高速開始":"OFF"}},
...
{"name":"CommonInterceptor","status":true,"description":"割り込みコモンイベントプラグイン","parameters":{"ニューゲームコモン":"5","ロードコモン":"","メニューコモン":""}},
{"name":"MakeScreenCapture","status":true,"description":"画面キャプチャ管理プラグイン","parameters":{"キャプチャキー":"F6","ファイル名":"image","保存形式":"png","連番桁数":"2","タイムスタンプ":"ON","署名":"","実行間隔":"0","効果音":"Computer"}},
{"name":"BattleSkinCustomize","status":true,"description":"バトル画面外観変更プラグイン","parameters":{"コマンドX座標":"デフォルト値"}},
