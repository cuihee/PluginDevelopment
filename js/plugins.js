...
{"name":"BugFixLoadErrorChoiceSetup","status":true,"description":"選択肢表示中のロードエラー修正プラグイン","parameters":{}},
{"name":"VariableNameAddId","status":true,"description":"変数名およびコモンイベント名のID自動付与プラグイン","parameters":{"バックアップ":"OFF"}}
];
