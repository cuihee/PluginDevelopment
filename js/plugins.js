...
var $plugins =
[
{"name":"DevToolsManage","status":false,"description":"デベロッパツール管理プラグイン","parameters":{"開始時に起動":"ON","常に前面表示":"ON","デベロッパツール表示位置":"0,0,1200,800","最小化切替キー":"F8","リロードキー":"F12","画面の左寄せキー":"F11","FPS表示":"OFF","タイトルカット":"OFF"}},
...
{"name":"PictureVariableSetting","status":false,"description":"ピクチャの変数設定プラグイン","parameters":{"初期値":"ON","ピクチャ表示最大数":"150"}},
{"name":"BattleActorFaceVisibility","status":false,"description":"戦闘中顔グラフィック表示プラグイン","parameters":{"ウィンドウ表示":"ON","ウィンドウX座標":"","ウィンドウY座標":""}},
{"name":"GameStartEval","status":false,"description":"開始時スクリプト実行プラグイン","parameters":{"スクリプト1":"Input.keyMapper[8] = 'escape';","スクリプト2":"document.title = 'Ctrlでクレジット表示';","スクリプト3":"","スクリプト4":""}},
...
{"name":"BugFixPictureRotation","status":false,"description":"ピクチャの回転バグ修正プラグイン","parameters":{}},
{"name":"MessageWindowHidden","status":false,"description":"メッセージウィンドウ一時消去プラグイン","parameters":{"ボタン名称":"shift"}},
{"name":"CacheManager","status":false,"description":"Selectively clear the image cache for memory usage improvements","parameters":{"Mobile only":"N","--------------------------------------------":"","Clear All":"Y","Clear Animations":"Y","Clear Battlebacks":"Y","Clear Battlers":"Y","Clear Characters":"Y","Clear Faces":"Y","Clear Parallaxes":"Y","Clear Pictures":"Y","Clear System":"N","Clear Tilesets":"Y","Clear Titles":"Y","Custom Images":""}},
...
{"name":"BugFixParallelEventAndCharacter","status":false,"description":"並列処理イベントのセーブ失敗バグ修正プラグイン","parameters":{}},
{"name":"PlayerShiftTurn","status":false,"description":"プレイヤーのその場方向転換","parameters":{"ボタン名称":"tab"}},
{"name":"FlexibleBattleBgm","status":false,"description":"敵グループごとの戦闘BGM設定プラグイン","parameters":{}},
...
{"name":"MessageSelectPicture","status":false,"description":"選択肢のピクチャ表示プラグイン","parameters":{"パラメータ":"デフォルト値"}},
{"name":"RestoreSaveData","status":false,"description":"セーブファイル復元プラグイン","parameters":{}},
...
{"name":"CustomizeConfigItem","status":false,"description":"オプション任意項目作成プラグイン","parameters":{"スイッチ項目1":"スイッチ項目1:OFF:0:OFF","数値項目1":"数値項目1:0:0:OFF:0:10:1","音量項目1":"音量項目1:0:0:OFF","文字項目1":"文字項目1:0:0:OFF:EASY, NORMAL, HARD, VERY HARD","スイッチ項目2":"スイッチ項目2:OFF:0:OFF","数値項目2":"数値項目2:0:0:OFF:0:10:1","音量項目2":"音量項目2:0:0:OFF","文字項目2":"文字項目2:0:0:OFF:EASY, NORMAL, HARD, VERY HARD\r"}},
...
{"name":"StateChangeIfRemove","status":false,"description":"ステート変化プラグイン","parameters":{}},
{"name":"BugFixImageOnLoad","status":false,"description":"画像ロード遅延時のエラー修正プラグイン","parameters":{}},
{"name":"AutomaticState","status":false,"description":"ステート自動付与プラグイン","parameters":{"パラメータ":"デフォルト値"}},
{"name":"GameStartEval","status":false,"description":"開始時スクリプト実行プラグイン","parameters":{"スクリプト1":"Input.keyMapper[8] = 'escape';","スクリプト2":"","スクリプト3":"","スクリプト4":""}},
{"name":"BugFixWebPlayTest","status":false,"description":"Web実行におけるテストオプション防止プラグイン","parameters":{}},
...
{"name":"SetupOptionCustomize","status":false,"description":"起動オプション調整プラグイン","parameters":{"描画モード":"1","テストプレー":"ON","FPS表示":"ON","オーディオ無効":"ON","任意オプション":"","ユーザオプション無効":"OFF"}},
